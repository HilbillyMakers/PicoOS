...
void init_warmWhiteLED(void)
{
    ...
    slice_num   = pwm_gpio_to_slice_num(WARM_WHITE_LED_PIN);
    ...
    divider     = clock_get_hz(clk_sys) / (WARM_WHITE_LED_FREQUENCY_HZ * WARM_WHITE_LED_WRAP_SIZE);
